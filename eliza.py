...
Original file is located at
    https://colab.research.google.com/drive/17cIb1IOMTeGLKgaX1741gDJt5HD7xDE1
...
script = {
    "no": {"decomposition": r".*",
           "reassembly": [
               ...
               "You are being a bit negative",
               "Why not"]},
    "hmm": {"decomposition": r".*hmm",
            "reassembly" : [
               'I am not sure I understand you fully'
            ]},
    "I":   {"decomposition": r".*I am (.*)",
            "reassembly": [
                'Is it because you are \1 that came to me?'
            ]},
